...
import Join_input from "../join_input/Join_input";
import { useState } from "react";
import From from "../forme/Form";

export function Home_c(): React.JSX.Element {
  const [isOpen, setIsOpen] = useState<boolean>(true);
  const toggleForm = () => {
    setIsOpen(!isOpen);
  };
  return (
    <div className="flex w-90rem  ps-10 pt-10 flex-wrap gap-4">
      {isOpen ? (
        <div className="">
          <button
            onClick={toggleForm}
